...
def process_files() -> None:
    with (open('num_pairs.txt', 'r', encoding='utf-8', newline='') as fnums,
          open('pseudonyms_generator.txt', 'r', encoding='utf-8', newline='') as fnames,
          open('result.txt', 'w', encoding='utf-8') as f):
        ...
        while True:
            ...
            f.write(f'{row_numbers = } {row_names = }')
